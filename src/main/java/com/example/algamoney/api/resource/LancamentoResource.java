...
//		OutputStream out = new FileOutputStream("C:\\Users\\ITX Gamer\\Desktop\\anexo-" + anexo.getOriginalFilename());
...
//		out.close();
	...
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_LANCAMENTO') and hasAuthority('SCOPE_read')")
	public List<LancamentoEstatisticoCategoriaDTO> porCategoria(){
		return this.lancamentoRepository.porCategoria(LocalDate.now());
	}
	
	@GetMapping("/estatistica/por-dia")
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_LANCAMENTO') and hasAuthority('SCOPE_read')")
	public List<LancamentoEstatisticoPorDiaDTO> porDia(){
